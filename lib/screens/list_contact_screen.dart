          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  final newContact = Contact(name: _nameController.text, phone: _phoneController.text);
                      ...
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                                onPressed: () {
                                  context.read<ContactBloc>().add(DeleteContact(new Contact(name: contact.name, phone: contact.phone)));
                                },
